...
const YOUTUBE_CALLBACK_ERROR_MESSAGES: Record<string, string> = {
  ...
  ENCRYPTION_FAILED: "PostFlow could not secure the YouTube credential. Please try again.",
  REFRESH_TOKEN_MISSING: SOCIAL_ACCOUNT_ERROR_MESSAGES.YOUTUBE_REFRESH_TOKEN_REQUIRED,
  UPSERT_FAILED: "PostFlow could not save the YouTube connection. Please try again.",
